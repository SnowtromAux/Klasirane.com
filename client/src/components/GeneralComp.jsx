...
export default class GeneralComp extends Component {
    ...
    fetchCompetitionData = () => {
        fetch(`https://klasirane.com/competitions/${this.props.competitionName}/alldata`)
          .then((response) => {
            if (!response.ok) {
    ...
    fetchData(){
        ...
        fetch(`https://klasirane.com/competitions/dir/get-names/${this.props.competitionName}`)
